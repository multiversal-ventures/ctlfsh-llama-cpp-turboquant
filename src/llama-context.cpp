...
llama_context * llama_init_from_model(
    ...
    if (params.flash_attn_type == LLAMA_FLASH_ATTN_TYPE_DISABLED &&
        (params.type_k == GGML_TYPE_TURBO3_0 || params.type_k == GGML_TYPE_TURBO4_0 || params.type_k == GGML_TYPE_TURBO_SPLIT_0 ||
         params.type_v == GGML_TYPE_TURBO3_0 || params.type_v == GGML_TYPE_TURBO4_0 || params.type_v == GGML_TYPE_TURBO_SPLIT_0)) {
