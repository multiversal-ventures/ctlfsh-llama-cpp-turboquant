...
ggml_tensor * llm_graph_context::build_attn(
    ...
    if (k->type == GGML_TYPE_TURBO3_0 || k->type == GGML_TYPE_TURBO4_0 || k->type == GGML_TYPE_TURBO_SPLIT_0 || k->type == GGML_TYPE_TURBO_SPLIT2_0) {
        if (q->ne[0] % 128 == 0) {
    ...
    if (v->type == GGML_TYPE_TURBO3_0 || v->type == GGML_TYPE_TURBO4_0 || v->type == GGML_TYPE_TURBO_SPLIT_0 || v->type == GGML_TYPE_TURBO_SPLIT2_0) {
        if (cur->ne[0] % 128 == 0) {
